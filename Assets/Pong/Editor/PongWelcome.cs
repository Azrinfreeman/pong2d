...
#pragma warning restore CS0618 // Type or member is obsolete
	...
	public void OnGUI()
	{
		...
		if (
			Button(
				supportIcon,
				"Have any problem or question about this asset?\nWant to participate as an artist? ",
				"Don't hesitate to write me, whenever you want."
			)
		)
		{
		...
		if (
			Button(
				facebookIcon,
				"Like me on facebook to get access direct download",
		...
		if (
			Button(
				twitterIcon,
				"Follow me on twitter to get access direct download",
				"Be informed of the latest updates."
			)
		)
		{
		...
		if (
			DonateButton(
				patreonIcon,
				"PLEASE DONATE ME",
				"Being a student is economically hard\n   If you want me to order a meal :)."
			)
		)
		{
